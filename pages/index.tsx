  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="The Scope Three manifesto and pledge" />
      </Head>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          we do: some emissions are entirely under our control, while others are
          less so. For most people, the biggest potential environmental impact
          isn&apos;t from what we do directly, it&apos;s from what we buy.
        </p>
        ...
        <div className={styles.card}>
          ...
          <p>
            ...
            For many of us, driving our cars and heating our homes are probably
            the biggest contributors to our scope one emissions.
          </p>
          <p>
          ...
          <p>
            ...
            behaviour of the companies they buy from, but supply chains are long
            and complex and for the most part opaque to us.
          </p>
          <p>
        ...
        <div className={styles.card}>
          ...
          <p>All our emissions are scope three emissions for our customers.</p>
          ...
          <p>
            All suppliers should tell their customers what the carbon impact of
            their custom is.
          </p>
          <p className={styles.indent}>
            Without this requirement, the externality of environmental impact is
            invisible to the customer. They can make informed guesses, but there
            is no incentive in the customer/supplier relationship for the
            supplier to lessen the environmental impact of their products.
          </p>
          <p>That impact should be zero.</p>
          <p className={styles.indent}>This internalises the externality.</p>
          <p className={styles.indent}>
            The important change from the point of view of the purchaser is that
            the cost is in the headline price: it makes comparing suppliers that
            much easier, and it removes the burden of scope three emissions from
            customers.
          </p>
          <p className={styles.indent}>
            It also lets suppliers directly benefit from their efforts to reduce
            the impact of their business to the environment, as their
        ...
        <div className={styles.card}>
          ...
          <p>
            As part of our work towards a sustainable future, we pledge to work
            towards a Scope Three Zero future where scope three emissions are
            dealt with by the supply chain directly.
          </p>
          <p>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.indent}>
            ...
            transparent about the total cost of what they sell you, rather than
            hiding the cost of their products by passing the responsibility of
            working out CO₂ emissions and dealing with them onto the consumer.
          </p>
          <p className={styles.indent}>
          ...
          <p>I sell to the public, why should I sign the Scope Three Pledge?</p>
          <p className={styles.indent}>
          ...
          <p className={styles.indent}>
            ...
            their willingness to help. Ensuring that all our products have their
            CO₂ accounted for makes it easier to compare products on a
            like-for-like basis.
          </p>
          <p>
            I&apos;m a part of the supply chain, why am I being encouraged to
            sign the Scope Three Pledge, and why should I encourage my suppliers
            to do the same?
          </p>
          <p className={styles.indent}>
